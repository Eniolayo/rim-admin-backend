...
export class ApiKeyXapiSecret1764190441447 implements MigrationInterface {
    name = 'ApiKeyXapiSecret1764190441447'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."API_KEYS_status_enum" AS ENUM('active', 'inactive', 'revoked')`);
        await queryRunner.query(`CREATE TABLE "API_KEYS" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "apiKey" character varying(255) NOT NULL, "apiKeyHash" character varying(255) NOT NULL, "apiSecret" character varying(255) NOT NULL, "name" character varying(255) NOT NULL, "email" character varying(255) NOT NULL, "description" text, "status" "public"."API_KEYS_status_enum" NOT NULL DEFAULT 'active', "lastUsedAt" TIMESTAMP, "expiresAt" TIMESTAMP NOT NULL, "createdBy" uuid NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_f45a6e94c2c642358f58a39c3e4" UNIQUE ("apiKey"), CONSTRAINT "UQ_9ece6f2612465b9085915f3181a" UNIQUE ("email"), CONSTRAINT "PK_788b12ad3181202d1093d658a87" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_f45a6e94c2c642358f58a39c3e" ON "API_KEYS" ("apiKey") `);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_f45a6e94c2c642358f58a39c3e"`);
